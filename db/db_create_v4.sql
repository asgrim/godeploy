...
-- -----------------------------------------------------
-- Table `godeploy`.`ssh_key_types`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `godeploy`.`ssh_key_types` ;

CREATE  TABLE IF NOT EXISTS `godeploy`.`ssh_key_types` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(45) NOT NULL ,
  PRIMARY KEY (`id`) )
ENGINE = MyISAM;
...
-- -----------------------------------------------------
-- Table `godeploy`.`ssh_keys`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `godeploy`.`ssh_keys` ;

CREATE  TABLE IF NOT EXISTS `godeploy`.`ssh_keys` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `fk_table1_ssh_key_types1`
    ...
    REFERENCES `godeploy`.`ssh_key_types` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = MyISAM;
...
CREATE  TABLE IF NOT EXISTS `godeploy`.`projects` (
  ...
  CONSTRAINT `fk_projects_ssh_keys1`
    ...
    REFERENCES `godeploy`.`ssh_keys` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = MyISAM;
...
-- -----------------------------------------------------
SET AUTOCOMMIT=0;
insert into `godeploy`.`deployment_statuses` (`id`, `code`, `name`) values (1, 'PREVIEW', 'Previewing');
insert into `godeploy`.`deployment_statuses` (`id`, `code`, `name`) values (2, 'RUNNING', 'Running');
insert into `godeploy`.`deployment_statuses` (`id`, `code`, `name`) values (3, 'COMPLETE', 'Completed (no errors)');
insert into `godeploy`.`deployment_statuses` (`id`, `code`, `name`) values (4, 'FAILED', 'Failed - There were errors (see below)');
...
-- -----------------------------------------------------
SET AUTOCOMMIT=0;
insert into `godeploy`.`deployment_file_statuses` (`id`, `code`, `name`) values (1, 'NEW', 'Not started');
insert into `godeploy`.`deployment_file_statuses` (`id`, `code`, `name`) values (2, 'IN_PROGRESS', 'In progress');
insert into `godeploy`.`deployment_file_statuses` (`id`, `code`, `name`) values (3, 'COMPLETE', 'Complete');
insert into `godeploy`.`deployment_file_statuses` (`id`, `code`, `name`) values (4, 'FAILED', 'Failed');
...
-- -----------------------------------------------------
SET AUTOCOMMIT=0;
insert into `godeploy`.`configuration` (`id`, `key`, `value`) values (1, 'db_version', '4');
